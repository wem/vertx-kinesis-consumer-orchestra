...
data class VertxKinesisOrchestraOptions @JvmOverloads constructor(
     ...
     * Shard iterators are persisted on Redis per application, so it's possible that multiple application independently
    ...
    /**
     * Should supply the correct credential for the respectively environment.
     */
    ...
    /**
     * Strategy how and which shard iterator should be used.
     */
    ...
    /**
     * Class of record consumer verticle. Each consumer verticle will consumer and process one shard. This means
...
enum class ShardIteratorStrategy {
     ...
     * When there is no iterator information available on Redis, the latest (queried from Kinesis) will be used.
     */
    EXISTING_OR_LATEST,
